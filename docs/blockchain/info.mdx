...
- **RPC Endpoint**: `https://rpc.statemesh.net`
- **WebSocket Endpoint**: `wss://rpc.statemesh.net`
- **Wallet**: `wss://wallet.statemesh.net`

### Testnet
- **RPC Endpoint**: `https://rpc-test.statemesh.net`
- **WebSocket Endpoint**: `wss://rpc-test.statemesh.net`
- **Faucet**: `wss://faucet.statemesh.net`
- **Wallet**: `wss://wallet-test.statemesh.net`
